package com.kunting.client.login;



import com.kunting.client.MainLauncher;
import com.kunting.client.chat.ChatController;
import com.kunting.client.chat.Listener;
...
public class LoginController implements Initializable {
    ...
    @FXML public  TextField hostnameTextfield; // user input ip
    @FXML private TextField portTextfield;    // user input port
    @FXML private TextField usernameTextfield;  // user input nickname
    ...
    public void loginButtonAction() throws IOException {
        ...
        // Once the login button event starts, we create a listener
        Listener listener = new Listener(hostname, port, username, picture, chatController);

        // and then pass the listener to thread pool
